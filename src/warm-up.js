...
//console.log(`${pages} is less than 25: ${isShortStory}`);
...
console.log(`OK, maybe I could read that in a dat and a half.`);
}
...
var books = [`Do Androids Dream of Electric Sheep`, `Everything I Never Told You`, `Is Everyone Hanging Out Without Me? (and Other Concerns)`, `The Electric Kool-Aid Acid Test `,`Are You There, Vodka? It’s Me, Chelsea`];
